...
export default function Index() {
  ...
  const skills = {
    ...
    "Databases": ["MySQL", "SQL"],
    "Tools & IDEs": ["Eclipse", "Visual Studio Code", "Git", "Maven", "Postman", "JUnit"],
  ...
  const projects = [
    {
      ...
      technologies: ["Java 8", "Spring Boot", "MySQL", "JPA", "Postman", "REST APIs"],
      description: "Designed and developed a comprehensive full-stack RESTful API system for employee management operations",
      features: [
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-sm border-b">
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-bold text-primary">Malleswararao Duggineni</h1>
          ...
          <div className="bg-gradient-to-br from-hero-from to-hero-to text-white rounded-2xl p-8 md:p-12 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg mb-8 text-blue-50 max-w-3xl mx-auto">
                Java Backend Developer with 1+ years of experience in developing and maintaining RESTful APIs using Java 8, Spring Boot, and MySQL. Demonstrated expertise in object-oriented programming, microservices architecture, and clean code principles.
              </p>
            ...
            <Card>
              <CardContent className="p-8">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  I am a passionate Java Backend Developer with expertise in building scalable enterprise applications. 
                  With a strong foundation in object-oriented programming and modern development practices, I specialize 
                  in creating robust RESTful APIs using Java 8 and Spring Boot. My experience includes working with 
                  microservices architecture, database optimization, and Agile development methodologies. I'm committed 
                  to writing clean, maintainable code and delivering high-quality solutions that meet business requirements.
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <Card key={category} className="h-full">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    {category === "Programming Languages" && <Code className="w-5 h-5 text-primary" />}
                    {category === "Databases" && <Database className="w-5 h-5 text-primary" />}
                    {category === "Frameworks & Technologies" && <Server className="w-5 h-5 text-primary" />}
                    {category === "Web Technologies" && <Globe className="w-5 h-5 text-primary" />}
                    {category === "Tools & IDEs" && <Code className="w-5 h-5 text-primary" />}
                    {category}
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-muted-foreground">Proficient in Git for collaborative development and code management</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-3">Database Management</h3>
                    <p className="text-muted-foreground">Experience with query optimization and database design principles</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-3">API Development</h3>
                    <p className="text-muted-foreground">Strong understanding of RESTful web services and API documentation</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-3">Problem Solving</h3>
                    <p className="text-muted-foreground">Excellent analytical and debugging skills with attention to detail</p>
                  </div>
                </div>
              </CardContent>
            </Card>
